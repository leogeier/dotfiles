...
function! onedarksalad#set_highlight(group, style)
  call s:h(a:group, a:style)
endfunction

function! onedarksalad#extend_highlight(group, style)
...
" Python
call s:h("pythonBuiltin", {"fg": s:yellow})
call s:h("pythonBuiltinObj", {"fg": s:yellow})
call s:h("pythonBuiltinFunc", {"fg": s:yellow})
...
call s:h("pythonExceptions", {"fg": s:red})
call s:h("pythonBoolean", {"fg": s:purple})
call s:h("pythonDot", {"fg": s:white})
...
" dense-analysis/ale
call s:h("ALEError", { "fg": s:black, "bg": s:red })
call s:h("ALEWarning", { "fg": s:black, "bg": s:yellow })
