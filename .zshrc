...
# Remove host from prompt (for agnostic)
# TODO: Only do this if theme is agnoster
prompt_context() {
...
alias gdnp="git diff HEAD -- ':(exclude)package-lock.json'"

source /Users/leo/.source-cfg
